...
<head>
    ...
    <script src="https://cloud.tinymce.com/5/tinymce.min.js?apiKey=of87yv9kg508rpsfkct8u6x6terq0q22fii2velrkjcrayxf"></script>
    <script>
        tinymce.init({
            selector:'textarea',
            // menubar: false,
                    ...
                    <ul class="list-inline links-list pull-right">
                        <li>
                            <?php
                                ...
                                $sql=mysql_query("SELECT * FROM adm_usuarios WHERE id='$id'");
